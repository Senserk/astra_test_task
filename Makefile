...
clever_williams.o: clever_williams.c
	$(CC) -O0 -g $(CFALGS) -c -o clever_williams.o clever_williams.c
	

kirch.o: kirch.c
	$(CC) -O0 -g $(CFALGS) -c -o kirch.o kirch.c

print_kirch.o: print_kirch.c
	$(CC) -O0 -g $(CFALGS) -c -o print_kirch.o print_kirch.c

trusty_reflection.o: trusty_reflection.c
	$(CC) -O0 -g $(CFALGS) -c -o trusty_reflection.o trusty_reflection.c

bhaskara.o: bhaskara.c
	$(CC) -O0 -g $(CFALGS) -c -o bhaskara.o bhaskara.c
